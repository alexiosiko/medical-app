...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
	<div
	  data-slot="card"
	  className={cn(
		"bg-card text-card-foreground space-y-2 flex flex-col rounded-xl p-8 shadow-sm",
		className
	  )}
	  {...props}
	/>
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("leading-none  font-light text-sm max-md:text-center", className)}
      {...props}
    />
  )
}
