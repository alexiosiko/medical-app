...
export default function NavBar() {
  return (
		<div
			className='grid grid-cols-3 max-md:h-12 md:h-24 bg-background z-10 rounded-3xl fixed w-[95%] max-w-7xl md:top-16 max-md:top-9 left-1/2 transform -translate-x-1/2 -translate-y-1/2
